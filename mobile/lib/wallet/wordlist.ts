/**
 * lib/wallet/wordlist.ts
 *
 * BIP39 English wordlist — 2048 words for mnemonic seed phrase generation.
 * Embedded inline so the wallet SDK has zero external dependencies.
 *
 * Derived from the BIP39 specification:
