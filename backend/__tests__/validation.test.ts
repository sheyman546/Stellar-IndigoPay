...
describe("validateE164PhoneNumber", () => {
  it("should validate correct E.164 numbers", () => {
    ...
    expect(validateE164PhoneNumber("+44791123456")).toBe(true);
    expect(validateE164PhoneNumber("+447911234567890")).toBe(true);
  });

  it("should reject invalid E.164 numbers", () => {
    expect(validateE164PhoneNumber("2348123456789")).toBe(false);
    expect(validateE164PhoneNumber("+02348123456789")).toBe(false);
    expect(validateE164PhoneNumber("+234")).toBe(false);
    expect(validateE164PhoneNumber("+2348123456789012345")).toBe(false);
    expect(validateE164PhoneNumber("+2348123456789a")).toBe(false);
  });

  it("should accept various input formats and validate after sanitization", () => {
    expect(validateE164PhoneNumber("08123456789")).toBe(true);
    expect(validateE164PhoneNumber("  +234 812 345 6789  ")).toBe(true);
    expect(validateE164PhoneNumber("+234-812-345-6789")).toBe(true);
  });
});
