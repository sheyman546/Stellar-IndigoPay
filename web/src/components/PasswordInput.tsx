    ...
    return (
      <div className="w-full relative">
        {label && (
          <label
            htmlFor={props.id}
            className="block absolute -top-2.5 z-20 left-4 px-1 bg-white text-[11px] text-[#9CA3AF] pointer-events-none"
          >
            {label}
          </label>
        )}
        <div className="relative">
          <input
            ...
            className={`
              w-full px-4 py-3.5 pr-12 rounded-lg
              bg-white border border-[#E5E7EB]
              text-[#030213] placeholder:text-[#030213] text-sm tracking-widest
